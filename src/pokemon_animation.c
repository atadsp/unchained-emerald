...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_PIKACHU_PARTNER]    = BACK_ANIM_SHAKE_FLASH_YELLOW,
    ...
    [SPECIES_CLEFAIRY_PARTNER]   = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_EEVEE_PARTNER]      = BACK_ANIM_CONCAVE_ARC_SMALL,
