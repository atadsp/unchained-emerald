...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_PIKACHU_PARTNER] = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  9 },
    ...
    [SPECIES_CLEFAIRY_PARTNER]    = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 16 },
    ...
    [SPECIES_EEVEE_PARTNER]       = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  9 },
