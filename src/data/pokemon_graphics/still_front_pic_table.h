const struct CompressedSpriteSheet gMonStillFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(PIKACHU_PARTNER,       gMonStillFrontPic_Pikachu),
    ...
    SPECIES_SPRITE(CLEFAIRY_PARTNER,      gMonStillFrontPic_Clefairy),
    ...
    SPECIES_SPRITE(EEVEE_PARTNER, gMonStillFrontPic_Eevee),
