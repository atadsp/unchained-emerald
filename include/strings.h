...
extern const u8 gText_LevelCapOn[];
extern const u8 gText_LevelCapOff[];
extern const u8 gText_LevelCap[];
extern const u8 gText_ExpMult[];
extern const u8 gText_ExpMultHalf[];
extern const u8 gText_ExpMultOne[];
extern const u8 gText_ExpMultTwo[];
extern const u8 gText_BattleItems[];
extern const u8 gText_BattleItemsYes[];
extern const u8 gText_BattleItemsNo[];
