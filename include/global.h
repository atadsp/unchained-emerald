...
struct SaveBlock2
{
    ...
    /*0x14*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST]
             ...
             u16 optionsEnforceLevelCap:1; // OPTIONS_LEVEL_CAP_[ON/OFF] whether level cap is enforced.
             u16 optionsExperienceMultiplier:3; // OPTIONS_EXPERIENCE_MULTIPLIER_[HALF/ONE/TWO] whether level cap is enforced.
             u16 optionsAllowBattleItems:1; // OPTIONS_ALLOW_BATTLE_ITEMS_[YES/NO] whether level cap is enforced.
             //u16 padding1:4;
             //u16 padding2;
